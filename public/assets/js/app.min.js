...
$.fn.AdminSettings = function(t) {
    var i = this.attr("id"),
        ...
        a = {
            ...
            ManageTheme: function() {
                var a = t.Theme;
                "vertical" === t.Layout && (1 == a ? ($("body").attr("data-theme", "dark"), $("#theme-view").prop("checked", !0)) : ($("#" + i).attr("data-theme", "light"), $("body").prop("checked", !1)))
            },
            ...
            ManageThemeBackground: function() {
                var a;
                null != (a = t.LogoBg) && "" != a ? $("#" + i + " .topbar .top-navbar .navbar-header").attr("data-logobg", a) : $("#" + i + " .topbar .top-navbar .navbar-header").attr("data-logobg", "skin1"), null != (a = t.NavbarBg) && "" != a ? ($("#" + i + " .topbar .navbar-collapse").attr("data-navbarbg", a), $("#" + i + " .topbar").attr("data-navbarbg", a), $("#" + i).attr("data-navbarbg", a)) : ($("#" + i + " .topbar .navbar-collapse").attr("data-navbarbg", "skin1"), $("#" + i + " .topbar").attr("data-navbarbg", "skin1"), $("#" + i).attr("data-navbarbg", "skin1"))
            },
    ...
    $("#chat .message-center a").on("click", function() {
        ...
        var e;
        13 == a.keyCode && (e = $(this).attr("data-user-id"), a = msg_sent(a = $(this).val()), $(".chat-windows #user-chat" + e + " .chat-body .chat-list").append(a), $(this).val(""), $(this).focus()), $(".chat-windows #user-chat" + e + " .chat-body").perfectScrollbar({
            suppressScrollX: !0
        })
