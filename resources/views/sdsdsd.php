            ...
            <div class="card">
              ...
              <div class="card-body">
                <form class="mt-4" novalidate>
                  ...
                  <div class="mb-3 form-group">
                    <label
                      >Email Field <span class="text-danger">*</span></label
                    >
                    <div class="controls">
                      <input
                        type="email"
                  ...
                  <div class="mb-3 form-group">
                    <label
                      >Input with Icon <span class="text-danger">*</span></label
                    >
                    <div class="controls">
                  ...
                  <div class="mb-3 form-group">
                    ...
                    <div class="form-control-feedback">
                      <small
                        >Add <code>maxlength='10'</code> attribute for maximum
                  ...
                  <div class="mb-3 form-group">
                    ...
                    <div class="form-control-feedback">
                      <small
                        >Add <code>minlength="6"</code> attribute for minimum
                  ...
                  <div class="mb-3 form-group">
                    <label
                      >Only Numbers <span class="text-danger">*</span></label
                    >
                    <div class="input-group">
                      <span class="input-group-text"
                  ...
                  <div class="mb-3 form-group">
                    <label
                      >Maximum Number <span class="text-danger">*</span></label
                    >
                    <input
                      type="text"
                      name="maxNum"
                    ...
                    <div class="form-control-feedback">
                      ...
                      <small
                        >Add <code>max</code> attribute for maximum number to
                        accept. Also use
                  ...
                  <div class="mb-3 form-group">
                    <label
                      >Minimum Number <span class="text-danger">*</span></label
                    >
                    <div class="controls">
                      <input
                        type="text"
                    ...
                    <div class="form-control-feedback">
                      ...
                      <small
                        >Add <code>min</code> attribute for minimum number to
                        accept. Also use
                  ...
                  <div class="mb-3 form-group">
                    <label
                      ...
                      <small
                        ><i>Must start with 'a' and end with 'z'</i></small
                      ></label
                    >
                    <div class="controls">
                      <input
                      ...
                      <div class="form-control-feedback">
                        <small
                          >Add <code>pattern</code> attribute to set input
                          pattern. Also use
                  ...
                  <div class="mb-3 form-group">
                    <label
                      >Basic Select <span class="text-danger">*</span></label
                    >
                    <div class="controls">
                      <select
                        name="select"
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="mb-3 form-group">
                        <label
                          >Checkbox <span class="text-danger">*</span></label
                        >
                        <div class="controls">
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="mb-3 form-group">
                        <label
                          >Select Max 2 Checkbox<span class="text-danger"
                            >*</span
                          ></label
                        >
                        <div class="controls">
                    ...
                    <div class="col-md-6">
                      <div class="mb-3 form-group">
                        <label
                          >Minimum 2 Checkbox selection<span class="text-danger"
                            >*</span
                          ></label
                        >
                        <div class="controls">
                          ...
                          <fieldset>
                            <div class="form-check">
                              ...
                              <label class="form-check-label" for="customCheck8"
                                >I am unchecked checkbox too</label
                              >
                            </div>
                          </fieldset>
                          <fieldset>
                        ...
                        <fieldset class="controls">
                          <div class="form-check">
                            <input
                              ...
                              class="form-check-input"
                            />
                            <label class="form-check-label" for="styled_radio1"
                              >Check me</label
                            >
                          </div>
                        </fieldset>
                        <fieldset>
                          <div class="form-check">
                            <input
                              ...
                              class="form-check-input"
                            />
                            <label class="form-check-label" for="styled_radio2"
                              >or me</label
                            >
                          </div>
                        </fieldset>
