                                    ...
                                    <div class="d-flex align-items-center no-block">
                                        <div>
                                            ...
                                            <h3 class="mb-0 text-info fw-light">
                                                $23.5K
                                                <span class="text-muted fs-2"><i class="ri-arrow-up-line text-success"></i
                          >18.6</span
                        >
                      </h3>
                    </div>
                    <div class="ms-4">
                      <span class="text-muted">Last Week</span>
                                                <h3 class="mb-0 text-muted fw-light">
                                                    $945
                                                    <span class="text-muted fs-2"><i class="ri-arrow-down-line text-danger"></i
                          >46.3</span
                        >
                      </h3>
                    </div>
            ...
            <div class="col-lg-3 col-md-6 order-lg-3 order-md-2">
              <div class="card">
                <div class="card-body mb-0">
                  <h4 class="card-title">
                    Thursday
                    <span class="fs-3 fw-normal text-muted"
                      >12th April, 2021</span
                    >
                  </h4>
                      ...
                      /></span>
                        ...
                        <span class="action-icons">
                          <a href="javascript:void(0)" class="ps-3"
                            ><i class="ri-edit-box-line fs-6"></i
                          ></a>
                          <a href="javascript:void(0)" class="ps-3"
                            ><i class="ri-check-line fs-6"></i
                          ></a>
                          <a href="javascript:void(0)" class="ps-3"
                            ><i class="ri-heart-line fs-6"></i
                          ></a>
                        </span>
                                            <div class="ms-auto">
